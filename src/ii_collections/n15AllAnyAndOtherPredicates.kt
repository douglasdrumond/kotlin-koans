...
fun Customer.isFrom(city: City): Boolean = // Return true if the customer is from the given city
        this.city == city

fun Shop.checkAllCustomersAreFrom(city: City): Boolean = // Return true if all customers are from the given city
